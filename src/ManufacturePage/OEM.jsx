...
function OEM() {
    ...
    const handleDelete = async (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    const response = await axios.post(
                        "https://wemis-backend.onrender.com/manufactur/deleteOems",
    ...
    const handleEditClick = async (id) => {
        ...
        try {
            const response = await axios.post(
                "https://wemis-backend.onrender.com/manufactur/getOemsById",
                { oemsId: id },
                { headers: { Authorization: `Bearer ${tkn}` } }
            );
    ...
    const handleSave = async (e) => {
        ...
        try {
            const response = await axios.post(
                "https://wemis-backend.onrender.com/manufactur/editOemsById",
    ...
    const handleCreate = async (e) => {
        ...
        try {
            const response = await axios.post(
                "https://wemis-backend.onrender.com/manufactur/createOem",
                createData,
                { headers: { Authorization: `Bearer ${tkn}` } }
            );
