...
function DealerOem() {
  ...
  const fetchDistributors = async () => {
    try {
      const res = await axios.post(
        "https://wemis-backend.onrender.com/manufactur/fetchOems",
        {},
  ...
  const fetchDealers = async () => {
    try {
      const res = await axios.post(
        "https://wemis-backend.onrender.com/manufactur/fetchDelerUnderOems",
        {},
        { headers: { Authorization: `Bearer ${tkn}` } }
      );
  ...
  const handleCreateSubmit = async (e) => {
    ...
    try {
      await axios.post(
        "https://wemis-backend.onrender.com/manufactur/createDelerUnderOems",
        newDealer,
        { headers: { Authorization: `Bearer ${tkn}` } }
      );
  ...
  const handleDelete = async (id) => {
    ...
    if (confirm.isConfirmed) {
      try {
        ...
        await axios.post(
          "https://wemis-backend.onrender.com/manufactur/deleteDelerUnderOems",
...
const fetchDealerById = async (id) => {
  try {
    setLoadingEdit(true);
    const res = await axios.post(
      "https://wemis-backend.onrender.com/manufactur/getDelerUnderOemsById",
      { oemsId: id },
      { headers: { Authorization: `Bearer ${tkn}` } }
    );
  ...
  try {
    await axios.post(
      "https://wemis-backend.onrender.com/manufactur/editDelerOem",
      {
        ...editData,
