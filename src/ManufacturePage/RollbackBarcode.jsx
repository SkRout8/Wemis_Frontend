...
const ROLLBACK_API = "https://wemis-backend.onrender.com/manufactur/rollBackAllocatedBarCode";
const ELEMENT_API = "https://wemis-backend.onrender.com/manufactur/fetchElementData"; // New API for elements
