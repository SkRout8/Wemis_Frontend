...
function DealerDistributor() {
    ...
    const fetchDistributors = async () => {
        try {
            const res = await axios.post(
                "https://wemis-backend.onrender.com/manufactur/fetchDistributor",
                {},
    ...
    const fetchDealers = async () => {
        try {
            const res = await axios.post(
                "https://wemis-backend.onrender.com/manufactur/fetchDelerDistributor",
                {},
                { headers: { Authorization: `Bearer ${tkn}` } }
            );
    ...
    const handleCreateSubmit = async (e) => {
        ...
        try {
            await axios.post(
                "https://wemis-backend.onrender.com/manufactur/createDelerUnderDistributor",
                newDealer,
                { headers: { Authorization: `Bearer ${tkn}` } }
            );
    ...
    const handleDelete = async (id) => {
        ...
        if (confirm.isConfirmed) {
            try {
                ...
                await axios.post(
                    "https://wemis-backend.onrender.com/manufactur/deleteDelerDistributor",
