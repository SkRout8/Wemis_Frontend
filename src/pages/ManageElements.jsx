...
const ManageElements = () => {
  ...
  const addButton = async () => {
    ...
    try {
      ...
      await axios.post(
        "https://wemis-backend.onrender.com/superadmin/addElementCheckBox",
        { checkBoxoxName },
        {
          headers: {
  ...
  async function handleBrandSubmit(e) {
    ...
    try {
      setLoading(true);
      await axios.post(
        "https://wemis-backend.onrender.com/superadmin/createBrand",
        { brandName },
        {
          headers: {
            Authorization: `Bearer ${tkn}`,
  ...
  async function handleCategorySubmit(e) {
    ...
    try {
      setLoading(true);
      await axios.post(
        "https://wemis-backend.onrender.com/superadmin/createElementCategory",
  ...
  const fetchBrands = async () => {
    try {
      const response = await axios.post(
        "https://wemis-backend.onrender.com/superadmin/fetchAllBrands",
        {},
        {
          headers: {
            Authorization: `Bearer ${tkn}`,
  ...
  const fetchcategory = async () => {
    try {
      const response = await axios.post(
        "https://wemis-backend.onrender.com/superadmin/fetchAllCategory",
        {},
        {
          headers: {
            Authorization: `Bearer ${tkn}`,
  ...
  async function handleElementSubmit(e) {
    ...
    try {
      setLoading(true);
      await axios.post(
        "https://wemis-backend.onrender.com/superadmin/createElement",
  ...
  const fetchCostumize = async () => {
    try {
      const responsedata = await axios.post(
        "https://wemis-backend.onrender.com/superadmin/fetchAllElementCheckBox",
        {},
        {
          headers: {
            Authorization: `Bearer ${tkn}`,
  ...
  const fetchData = async () => {
    try {
      const response = await axios.post(
        "https://wemis-backend.onrender.com/superadmin/fetchAllElement",
        {},
        {
          headers: {
            Authorization: `Bearer ${tkn}`,
  ...
  const handleElementtypeSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://wemis-backend.onrender.com/superadmin/addElementType",
        {
  ...
  const handleElementModelSubmit = async (e) => {
    ...
    try {
      await axios.post(
        "https://wemis-backend.onrender.com/superadmin/addDeviceModel",
        {
  ...
  const fetchmodelData = async () => {
    try {
      const response = await axios.post(
        "https://wemis-backend.onrender.com/superadmin/fetchAllElementType",
        {},
        {
          headers: {
            Authorization: `Bearer ${tkn}`,
  ...
  const handleDevicePartSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      await axios.post(
        "https://wemis-backend.onrender.com/superadmin/addDevicePart",
        {
  ...
  const fetchpartData = async () => {
    try {
      const response = await axios.post(
        "https://wemis-backend.onrender.com/superadmin/fetchModelElementData",
        {},
        {
          headers: {
            Authorization: `Bearer ${tkn}`,
  ...
  const fetchTacData = async () => {
    try {
      const response = await axios.post(
        "https://wemis-backend.onrender.com/superadmin/fetchAllDeviceData",
        {},
        {
          headers: {
            Authorization: `Bearer ${tkn}`,
  ...
  const handleTACSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      await axios.post(
        "https://wemis-backend.onrender.com/superadmin/addTacNumber",
        {
  ...
  const fetchcopData = async () => {
    try {
      const response = await axios.post(
        "https://wemis-backend.onrender.com/superadmin/fetchAllTacNo",
        {},
        {
          headers: {
            Authorization: `Bearer ${tkn}`,
  ...
  const handleCOPSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      await axios.post(
        "https://wemis-backend.onrender.com/superadmin/addCopNumber",
        {
